        ...
        try:
            ...
            if data.get('direction') == 'right':
                if data.get('event') == 'ArrowRight':
                    target_position = max(prev_pos_right - move_amount, -half_width + 0.3)
                elif data.get('event') == 'ArrowLeft':
                    target_position = min(prev_pos_right + move_amount, half_width - 0.3)  
                else:
                ...
                if data.get('event') == 'D':
                    target_position = min(prev_pos_left + move_amount, half_width - 0.3) 
                elif data.get('event') == 'A':
                    target_position = max(prev_pos_left - move_amount, -half_width + 0.3)
                else:

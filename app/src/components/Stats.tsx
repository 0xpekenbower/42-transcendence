...
export default function StatsGame({width,height,type,time}: any ) {
    ...
    {type==="AreaChart" && (<AreaChart
        ...
        <Tooltip />
        <Legend />
        <Area type="monotone" dataKey="win" stroke="#8884d8" fillOpacity={1} fill="url(#colorWin)" />
        <Area type="monotone" dataKey="lose" stroke="#82ca9d" fillOpacity={1} fill="url(#colorLose)" />
        </AreaChart>)
    }
    </div>
  );

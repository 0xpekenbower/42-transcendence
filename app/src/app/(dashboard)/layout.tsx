    ...
    return (
        <div className="w-screen h-screen  bg-[#020D1A]">
            {/* <div className="top-0 left-4 w-[100px] h-full" id="sidebar">
              <div className="fixed w-[100px] h-[40%] top-1/2 -translate-y-1/2 items-center bg-radial from-[#3E586D] to-[#2E424F] rounded-[40px] ml-[30px]">
            ...
            {/* </div> */}
            <div className="grid grid-cols-1 grid-rows-1 h-[calc(100vh-250px)] w-[calc(100vw-200px)] ml-[150px] mr-[50px] mt-[0px] mb-[50px]" id="main">
